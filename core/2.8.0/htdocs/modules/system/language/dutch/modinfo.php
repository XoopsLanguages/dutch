...
//2.8.0
define('_MI_SYSTEM_PREFERENCE_ACTIVE_LANGUAGES', 'Talenbeheer inschakelen');
define('_MI_SYSTEM_PREFERENCE_ACTIVE_LANGUAGES_DESC', 'Beheer het register van landinstellingen, taalpakketten, statuscontroles en vertaaloverschrijvingen van de site.');
define('_MI_SYSTEM_BNAME14', 'Taalkeuze');
